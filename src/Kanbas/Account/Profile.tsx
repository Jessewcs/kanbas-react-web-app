...
export default function Profile() {
    return (    
        <div id="wd-profile-screen">
            ...
            <input id="wd-password" value="password" placeholder="password" type="password" className="form-control mb-2" />
            ...
            <Link id="wd-signin-btn" to="/Kanbas/Account/Signin" className="btn btn-primary w-100">Sign in</Link>
        </div>
    );
}